  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 md:space-y-8 animate-[fade-in_0.5s_ease-out] pb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
        <Card title="Data Retention" className="border-l-2 border-green-500/50">
          <div className="flex flex-col items-center text-center p-4">
            <div className="w-16 h-16 md:w-20 md:h-20 bg-green-900/20 rounded-full flex items-center justify-center text-green-400 mb-6 border border-green-500/20 shadow-[0_0_20px_rgba(34,197,94,0.1)]">
        ...
        <Card title="Audit Log">
          ...
          <div className="mt-8 pt-6 border-t border-white/5">
            <Button variant="destructive" className="w-full flex items-center justify-center gap-2 text-sm">
